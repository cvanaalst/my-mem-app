...
const dict = {
  nl: {
    ...
    close: "Sluiten",
    activityButton: "Synchronisatie-logboek",
    activityTitle: "Logboek",
    activityIntro: "Recente synchronisaties, back-ups en herstelacties op dit toestel.",
    activityEmpty: "Nog geen activiteit.",
    activityClear: "Wis logboek",
    logKindSync: "Synchronisatie",
    logKindBackup: "Back-up",
    logKindRestore: "Herstellen",
    logKindAutosync: "Auto-sync",
    logOk: "Gelukt",
    logError: "Mislukt",
    logSkipped: "Overgeslagen",
    logSkipOffline: "Offline",
    logSkipSignedOut: "Niet aangemeld (aanmelding verlopen)",
    typeLink: "Link",
    typeText: "Tekst",
    typeList: "Lijst",
    typeImage: "Foto",
  ...
  en: {
    ...
    close: "Close",
    activityButton: "Sync activity log",
    activityTitle: "Activity log",
    activityIntro: "Recent syncs, backups and restores on this device.",
    activityEmpty: "No activity yet.",
    activityClear: "Clear log",
    logKindSync: "Sync",
    logKindBackup: "Backup",
    logKindRestore: "Restore",
    logKindAutosync: "Auto-sync",
    logOk: "Success",
    logError: "Failed",
    logSkipped: "Skipped",
    logSkipOffline: "Offline",
    logSkipSignedOut: "Not signed in (login expired)",
    typeLink: "Link",
    typeText: "Text",
    typeList: "List",
    typeImage: "Photo",
